...
const en = {
  ...
  codexRouting: "Codex Routing",
  directRoute: "Direct Route — Codex Web GPT manages Codex routing",
  externalProvider: "External Provider — routing is managed by OpenCodex or another external router",
  externalProviderStatus: "Routing managed externally",
  externalProviderSetupBody: "Run the independent OpenAI Responses provider on 127.0.0.1:17841. Codex routing and model selection remain owned by OpenCodex.",
...
const zh: Record<keyof typeof en, string> = {
  ...
  coreSetup: "核心设置",
  codexRouting: "Codex 路由",
  directRoute: "直接路由 — 由 Codex Web GPT 管理 Codex 路由",
  externalProvider: "外部 Provider — 由 OpenCodex 或其他外部路由器管理路由",
  externalProviderStatus: "路由由外部管理",
  externalProviderSetupBody: "在 127.0.0.1:17841 运行独立的 OpenAI Responses Provider。Codex 路由和模型选择仍由 OpenCodex 管理。",
...
const ja: Record<keyof typeof en, string> = {
  ...
  coreSetup: "基本セットアップ",
  codexRouting: "Codex ルーティング",
  directRoute: "直接ルート — Codex Web GPT が Codex ルーティングを管理",
  externalProvider: "外部 Provider — OpenCodex または外部ルーターがルーティングを管理",
  externalProviderStatus: "ルーティングは外部で管理",
  externalProviderSetupBody: "127.0.0.1:17841 で独立した OpenAI Responses Provider を実行します。Codex のルーティングとモデル選択は OpenCodex が管理します。",
